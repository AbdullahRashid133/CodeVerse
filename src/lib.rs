...
#[derive(Debug)]
pub struct CodeVerseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CodeVerseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CodeVerse processing");
    
    let mut processor = CodeVerseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CodeVerseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CodeVerseProcessor::new(false);
